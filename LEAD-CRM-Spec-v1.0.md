...
| O13 | Can `part_time` create people? Matrix gives person "A" (assigned only), which says nothing about creating. Currently allowed                                                                                                                                                                                               | §6, 9.1 Add person     | Sprint 1           | Management             |
